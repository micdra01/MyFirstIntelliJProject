...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(exercises.exercise1(scanner.nextLine()));
        ...
        System.out.println(exercises.exercise6(scanner.nextLine()));
        System.out.println("Exercise 7) palindrome. Type your input below:");
        System.out.println(exercises.exercise7(scanner.nextLine()));
        System.out.println("Exercise 8) make the text alternate caps. Type your input below:");
        System.out.println(exercises.exercise8(scanner.nextLine()));
        System.out.println("Exercise 9) make 1337 5|*34|< out of it. Type your input below:");
        System.out.println(exercises.exercise9(scanner.nextLine()));
        scanner.close();
    }
}